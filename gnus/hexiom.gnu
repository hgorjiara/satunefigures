...
plot 'data/hexiom.txt' using ($2*scale):xtic(1) ti col, '' u ($3*scale) ti col, '' u ($4*scale) ti col, '' u ($5*scale) ti col, '' u ($6*scale) ti col, '' u ($7*scale) ti col
